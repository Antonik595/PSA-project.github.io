	...
	3:{
		...
		<div class="com">
			...
			<section>
				...
				<p>Помощник ведущего разработчика, Мап дизайнер, дизайнер компонентов карт, программист</p>
...
weapon = {
  ...
  "Ak74-M" : {
	...
	19:{
	  data: "Видыэнергощитов",
	  text: "Виды энергощитов",
	  html: `
	  <p>Энергощит служит защитой игрока от попаданий противника, тем самым спасая здоровье</p>
		<ul>
			<li>Малый (200 энергоочков)</li>
			<li>Средний (500 энергоочков)</li>
			<li>и Большой (1000 энергоочков)</li>
		</ul>
		<h3>Условия:</h3>
		<ul>
			<li>10 очков энергощита снимается при попадании противника</li>
			<li>50 очков энергощита снимается за взрыв гранаты, мины и прочих взрывов</li>
			<li>100 очков энергощита снимается за попадание ракеты</li>
			<li>Восстанавливается после 10 энергоочков при 5 секунд вне бое активности и попадания противника</li>
			<li>1 минута вне боевой активности, полное восстановление энергозапаса энергощита</li>
		</ul>
		`,
	},
	
	20:{
	  data: "Снаряжениеиусиление",
	  text: "Снаряжение и усиление",
	  html: `
	  <p>Немного о снаряжении и усилениях</p>
		<h3>Список:</h3>
		<ul>
			<li>Бронежилет: 100 евро (+50 брони)</li>
			<li>Бронежилет + каска: 200 евро (+100 брони)</li>
			<li>Боевой экзокостюм: 350 евро (+200 брони)</li>
			<li>Супер броня: 500 евро (+300 брони)</li>
			<li>Экспериментальная броня: 1000 евро (+500 брони)</li>
			<li>Мед шприц: 10 евро (восстанавливает 10% здоровья)</li>
			<li>Малый мед пакет: 25 евро (восстанавливает 25% здоровья)</li>
			<li>Средняя аптечка: 50 евро (восстанавливает 50% здоровья)</li>
			<li>Большой мед бокс: 100 евро (полностью восстанавливает здоровье)</li>
			<li>Энергетик: 20 евро (ускорение на 25% на 5 минут, используется 1 раз за бой)</li>
			<li>Боевой стимулятор: 50 евро (ускорение на 50% на 4 минуты, используется 1 раз за бой)</li>
			<li>Адреналин: 100 евро (ускорение на 100% на 3 минуты, восстановление 5% здоровья, используется 1 раз за бой)</li>
			<li>Авиа удар: 500 евро (урон 100-250, случайно падающие ракеты, действует 10 секунд)</li>
		</ul>
		<span>В дальнейшем список снаряжения и усиления будет увеличиваться...</span>
		`,
	},
	/*
	21:{
